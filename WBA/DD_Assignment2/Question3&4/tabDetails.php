<?php
	...
	if(isset($_GET['tabId']) and $_GET['tabId']!='') {
		...
		$sql = "SELECT tabName,tabPrice,tabDescription,tabSize,tabId FROM tablet WHERE tabId = $tabId";
		...
		$sql = "SELECT comments,rating,postTime FROM tablet,review WHERE tablet.tabId = review.tabId and review.tabId = $tabId";
