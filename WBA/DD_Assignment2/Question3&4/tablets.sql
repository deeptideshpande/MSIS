...
INSERT INTO `review` (`reviewId`, `comments`, `rating`, `postTime`, `tabId`) VALUES
(2, 'Amazing', 2, '2014-04-13 02:15:14', 1),
(3, 'Ok', 3, '2014-04-13 18:49:44', 2),
(4, 'Cool.', 2, '2014-04-13 19:02:42', 2),
(5, 'Nice.', 1, '2014-04-14 03:42:00', 3);
...
(4, 'iPad Mini', 399, 'ipadMini-7.jpeg', 'It''s the iPad Air in a smaller more affordable package. And with an A7 chip in tow, access to Apple''s still unbeatable App Store, and a razor-sharp screen, the Mini with Retina is the best small tablet yet.', 7);
